...
using System.IO;
using WendigoEnemy.Configuration;
...
namespace WendigoEnemy {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var bundleName = "wendigoenemyassets";
            ...
            var WendigoEnemy = ModAssets.LoadAsset<EnemyType>("WendigoEnemyObj");
            var WendigoEnemyTN = ModAssets.LoadAsset<TerminalNode>("WendigoEnemyTN");
            var WendigoEnemyTK = ModAssets.LoadAsset<TerminalKeyword>("WendigoEnemyTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var WendigoEnemyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var WendigoEnemyCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(WendigoEnemy.enemyPrefab);
            ...
            Enemies.RegisterEnemy(WendigoEnemy, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, WendigoEnemyTN, WendigoEnemyTK);
            // For using our rarity tables, we can use the following:
            // Enemies.RegisterEnemy(WendigoEnemy, WendigoEnemyLevelRarities, WendigoEnemyCustomLevelRarities, WendigoEnemyTN, WendigoEnemyTK);
